...
const NumberMemoryGame = () => {
  ...
  const endGame = async () => {
    ...
    try {
      await gamesAPI.submitResult("numberMemory", {
        score,
        level,
        duration,
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="text-center mb-8">
        ...
        <Text className="text-gray-600 text-lg">
          Ko'rsatiladigan raqamlar ketma-ketligini eslab qoling
        </Text>
      </div>
        ...
        <div className="flex flex-col items-center justify-center h-full">
          ...
          {gameState === "idle" && (
            ...
            >
              ...
              <Title level={3}>O'yinni boshlashga tayyormisiz?</Title>
              <Text className="text-gray-600 block mb-6">
                Raqamlar ketma-ketligi ko'rsatiladi. Ularni to'g'ri tartibda
                eslab qoling!
              </Text>
              <Space size="large">
                <Button
          ...
          {gameState === "showing" && (
            <motion.div
              ...
              className="text-center space-y-6"
            >
              <Title level={3}>Eslab qoling!</Title>
          ...
          {gameState === "input" && (
            ...
            >
              <Title level={3}>Raqamlarni kiriting</Title>
              <Text className="text-gray-600 block">
                Ko'rgan raqamlaringizni ketma-ket yozing
              </Text>
